...
export const PDFTemplate = forwardRef<HTMLDivElement, PDFTemplateProps>(
  ({ portfolioData, experienceData, profileData }, ref) => {
    ...
    const FooterContact = () => (
      <div className="mt-8 border-t pt-6 flex justify-between text-[10px] text-gray-500 font-medium break-inside-avoid">
    ...
    return (
      <div
        ref={ref}
        className="bg-gray-50 flex flex-col p-12 mx-auto"
          ...
          <div className="w-1/3">
            <div className="w-full h-64 bg-transparent mb-8 flex justify-center items-start">
              <img
                ...
                alt="Formal Profile"
                className="max-w-full max-h-full object-contain transition-all rounded-xl shadow-md"
                crossOrigin="anonymous"
              />
            </div>
