...
export const translations: Translations = {
  ...
  // About Page
  "about.githubTitle": { id: "Aktivitas & Progres GitHub", en: "GitHub Progress & Activity", de: "GitHub Fortschritt & Aktivität" },
  "about.githubSubtitle": { id: "Ringkasan langsung kontribusi open-source, streak ngoding, dan repositori publik saya.", en: "A live overview of my open source contributions, coding streaks, and repositories.", de: "Ein Live-Überblick über meine Open-Source-Beiträge, Coding-Streaks und Repositories." },
  "about.totalContributions": { id: "Total Kontribusi", en: "Total Contributions", de: "Gesamte Beiträge" },
  "about.currentStreak": { id: "Streak Saat Ini", en: "Current Streak", de: "Aktueller Streak" },
  "about.longestStreak": { id: "Streak Terpanjang", en: "Longest Streak", de: "Längster Streak" },
  "about.publicRepos": { id: "Repositori Publik", en: "Public Repos", de: "Öffentliche Repos" },
  "about.pastYear": { id: "tahun terakhir", en: "past year", de: "im letzten Jahr" },
  "about.days": { id: "hari", en: "days", de: "Tage" },
  "about.activeDays": { id: "hari aktif di tahun terakhir", en: "active days in last year", de: "aktive Tage im letzten Jahr" },
  "about.viewProfile": { id: "Lihat di GitHub", en: "View on GitHub", de: "Auf GitHub ansehen" },
  "about.errorLoadingGithub": { id: "Tidak dapat memuat data kontribusi langsung dari GitHub.", en: "Unable to fetch live contributions directly from GitHub.", de: "Live-Beiträge konnten nicht von GitHub geladen werden." },
  "about.updatedDaily": { id: "Diperbarui otomatis via GitHub API", en: "Updated daily via GitHub API", de: "Täglich aktualisiert über die GitHub-API" },
  "about.less": { id: "Sedikit", en: "Less", de: "Weniger" },
  "about.more": { id: "Banyak", en: "More", de: "Mehr" },
