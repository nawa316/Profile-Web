...
export default function Home() {
  return (
    <>
      <div className="flex flex-col bg-[#009dff]">
        <nav className="flex w-full items-center flex-row justify-center fixed px-6 py-2 top-0 z-10">
          <p className="mr-auto content-center justify-center self-center items-center text-3xl font-bold dm_serif_text text-white">
            Awan
          </p>
          <div className="hidden md:block max-w-[400px] h-fit border rounded-full border-dashed dm_serif_text">
            <RunningText />
          </div>
        ...
        <div
          className="w-screen h-[1000px] flex flex-row justify-center items-center px-0 py-2.5"
          id="home"
        >
          <div>
        ...
        <div
          className="bg-blue-500 h-[600px] py-[10px] w-screen flex flex-col justify-center items-center"
          id="experience"
        >
